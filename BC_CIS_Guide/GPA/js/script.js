...
function addCourse( ) {
    ...
    cell2.innerHTML = "<input type=\"text\" id=" + nid + " placeholder=\"Enter Course Name\">";
    cell3.innerHTML = "<input type=\"number\" id=" + cid + " min=\"0\" placeholder=\"Enter your credit\">";
    cell4.innerHTML = "<input type=\"text\" id=" + gid + " placeholder=\"Enter your grade\">";
}
